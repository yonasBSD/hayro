...
use crate::font::blob::{
    ...
    HELVETICA_BOLD, HELVETICA_BOLD_ITALIC, HELVETICA_ITALIC, HELVETICA_REGULAR,
    TIMES_BOLD, TIMES_ITALIC, TIMES_REGULAR, TIMES_ROMAN_BOLD_ITALIC,
    ZAPF_DINGS_BAT,
};
...
pub(crate) fn select_standard_font(dict: &Dict) -> Option<StandardFont> {
    ...
    match dict.get::<Name>(BASE_FONT)?.as_ref() {
