...
#[test]
fn color_space_calgray() {
    run_test("color_space_calgray", None);
}
#[test]
fn color_space_calrgb() {
    run_test("color_space_calrgb", Some(0..=8));
}
#[test]
...
#[test]
fn integration_matplotlib_2() {
    run_test("integration_matplotlib_2", None);
}
#[test]
